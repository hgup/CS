...
myRegions <- read_excel("datafiles/worldenergymix.xlsx")

myC1<-rgb(80,80,80,155,maxColorValue=255)
myC2<-rgb(255,97,0,155,maxColorValue=255)

myRegions$Region<-NULL
myLabelling<-c("Oil","Coal","Gas","Renewable Energies","Nuclear nenergy")
# Create chart
...
mtext(side=1,line=2,"Source: German Federal Agency for Civic Education: keyword ’Enegiemix’ [energy mix], www.bpb.de [&
